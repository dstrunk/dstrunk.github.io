...
const BlogPage = ({ data }) => (
  <Layout>
    ...
    <p>I've been blogging since 2012. In that time, I've picked up some new languages (from Ruby to PHP and JavaScript), switched jobs (design to Magento development), and switched editors too many times to count (vim to PhpStorm to VSCode to vim to …).</p>

    <p>I will always keep these posts on my site for posterity's sake, but I do not see myself maintaining a general web blog for the foreseeable future. For that reason, please consider this blog archived.</p>
